...
$(document).ready(function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if (response.status == 'Failed'){
                    ...
                    $('#cart_counter').html(response.cart_counter.cart_count)
                    swal(response.status, response.message, "success")
                    if(document.getElementById("cart-item-"+cart_id)){
    ...
    $(".add_hour").on('click', function(e){
        ...
        // var csrf_token_1 = document.querySelector("[name=csrfmiddlewaretoken]").value
        // var csrf_token_2 = document.querySelector("input[name=csrfmiddlewaretoken]").value
        var url = document.getElementById('add_hour_url').value

        console.log(day, from_hour, to_hour, is_closed, csrf_token)
        // console.log(csrf_token_1, csrf_token_2)
